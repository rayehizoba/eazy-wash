...
import {View, ScrollView, TouchableOpacity, Text, Pressable, RefreshControl} from 'react-native';
...
function HomePage(props) {
  ...
  const refreshing = props.offers.fetch || props.orders.fetch || props.services.fetch;

  React.useEffect(fetchData, []);

  const onRefresh = React.useCallback(fetchData, []);
